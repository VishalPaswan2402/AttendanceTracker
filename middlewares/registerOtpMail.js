module.exports.registerOtpMail = (username, otp) => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Comic+Neue:wght@700&family=DM+Serif+Display&family=Lora:ital,wght@0,400..700;1,400..700&family=PT+Sans:ital,wght@0,400;0,700;1,400;1,700&family=Protest+Revolution&family=Roboto+Slab:wght@100..900&family=Song+Myung&display=swap" rel="stylesheet">
...
<body>
    <div class="card" style="width: 17rem;">
        <div class="card-body">
            ...
            <div class="data">
                <p class="card-title paddings">It seems you are registering at Attendance Tracker website and trying to verify your email.</p>
            </div>
            <div class="data">
                <p class="card-text paddings">Here is the verification code, <strong>${otp}</strong> please use it to verify your email. It is valid for 2 minutes only.</p>
            </div>
            <div class="data">
                <p class="card-text paddings">Do not share this verification code with others.</p>
            </div>
            <div class="data">
                <p class="card-text paddings">If you didn't request this email, you can ignore and delete it. Thank you for understanding.</p>
            </div>
            <div class="foot">
                <h4><i class="fa-regular fa-copyright"></i> 2024 Attendance Tracker India, All Rights Reserved.</h4>
            </div>
        </div>
    </div>
